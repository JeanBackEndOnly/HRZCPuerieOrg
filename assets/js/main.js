...
// CAREER PATH ==========================================================================
  $(document).on("submit", "#career-path-form", function (e) { 
      e.preventDefault();
      const $form = $(this);
      if ($form.data("isSubmitted")) return;
      $form.data("isSubmitted", true);
      ...
      $.ajax({
          url: base_url + "authentication/action.php?action=career_path_form",
          type: "POST",
          data: formData,
          processData: false,
          contentType: false,
...
// SCHEDULE TEMPLATE ====================================================================
  ...
  $(document).on("submit", "#schedule-for_employee-form", function (e) {
    e.preventDefault();
    const $form = $(this);
    if ($form.data("isSubmitted")) return;
    $form.data("isSubmitted", true);
    ...
    $.ajax({
      url: base_url + "authentication/action.php?action=schedule_for_employee_form",
      type: "POST",
      data: formData,
      processData: false,
      contentType: false,
