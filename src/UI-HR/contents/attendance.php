                    ...
                    <div class="card mb-3 shadow-sm">
                        ...
                        <div class="card-body table-responsive overflow-auto" style="max-height: 250px;">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody class="text-left" id="attendance_table">
                                    <!-- JS will fill -->
                                </tbody>
                            </table>
                        </div>
...
<script>
    $(document).ready(function () {
                    ...
                    response.data.forEach(emp => {
                        ...
                        tbody += `
                            <tr>
                                ...
                                <td>${emp.position}</td>
                                <td>${emp.Department_name || 'No Update'}</td>
        ...
        function attendanceList(employeeID = null) {
            $.ajax({
                type: "POST", // usually POST when sending data
                url: `${base_url}/authentication/transact_action.php?action=getAttendanceList`, // your endpoint
                data: { employee_id: employeeID }, // send employee ID if needed
                dataType: "json",
                success: function (res) {
                    let tbody = '';
