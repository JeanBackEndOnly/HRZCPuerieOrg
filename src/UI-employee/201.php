...
?>
<div class="bg-gradient-primary col-md-12 col-12 h-auto p-3 d-flex align-items-center justify-content-between mb-2">
        <div class="col-md-7 d-flex">
            <img src="../../assets/image/system_logo/pueri-logo.png" class="me-2 media-pending-img" style="height: auto; width: 50px;">
            <h2 class="m-0 d-flex align-items-center fw-bold text-white">Zamboanga Puericulture Center Org.144 inc.</h2>
        </div>
        <div class="col-md-5 d-flex justify-content-end">
            <a href="pending.php"><button class="btn btn-sm btn-info m-0 button-media-text">Back to hompage</button></a>
        </div>
    </div>
<section class="col-md-12 col-12">
    ...
    <div class="card shadow-sm p-3 scroll-media">
