...
<body>
    ...
    color: #fff;">
        ...
        <div class="col-md-3 d-flex justify-content-end">
            <a href="inactive_workHistory.php?employee_id=<?= $_SESSION['employeeData']['employee_id'] ?>"><button class="btn btn-info m-0 fw-bold me-3 text-white">Work History</button></a>
        </div>
    </div>
